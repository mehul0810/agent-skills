...
- Normal reversible non-production work continues without owner waiting. Require current approval for production/beta tags/releases, publish/deploy, production/main merge, destructive or transfer actions, uncertain side effects, pricing/licensing, privacy/security posture, public API/schema/breaking contracts, or broad positioning.
