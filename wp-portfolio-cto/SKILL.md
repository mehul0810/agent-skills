...
- Resolve material owner instructions and corrections through `../shared/references/owner-decision-resolution.md`. Preserve current constraints, distinguish direction from authorization, and never turn one exact approval or temporary preference into standing portfolio authority.
