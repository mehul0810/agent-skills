...
- `references/delivery-excellence.md`, `references/enterprise-acceptance-criteria-templates.md`, `references/planning-drift-control.md`, `references/test-coverage-discipline.md`, `references/changelog-release-notes.md`, `references/release-contract-compatibility.md`: requirements, PRD/SOW, estimates, milestones, enterprise acceptance criteria, scope drift control, risk-calibrated validation, test coverage discipline, changelog discipline, release contracts, and compatibility policy.
