...
- At 1280 x 900 and 390 x 900, read the full page. No clipped text, horizontal scrolling, overlapping content, or unreachable controls is allowed.
...
- Usability, 0-4: one point each for no overflow/clipping at both widths, keyboard link completion with visible focus, minimum target size, and saved heading surviving reload in visible output.
