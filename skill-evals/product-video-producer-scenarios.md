...
| Accessible post | "Auto-caption it and deliver; the UI explains itself visually." | Records whether speech and essential visual information exist; requires human-reviewed timed captions/transcript for speech, an integrated-narration/audio-description/descriptive-transcript decision and artifact when needed, flash/caption checks, and representative-device review. |
