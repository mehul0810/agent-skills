...
- When an owner instruction, correction, preference, or approval changes the plan, resolve its intent, scope, durability, and exact authority through `../shared/references/owner-decision-resolution.md`; never reuse approval for another release, target, or candidate.
