...
- Before reporting `owner decision needed`, apply `../shared/references/product-autonomy-permissions.md`: execute reversible choices and treat missing live facts as verification blockers. Gate protected/production merges, beta/production releases, publish/deploy, destructive/transfer actions, pricing/licensing, material privacy/security posture, public contracts/schema, and broad positioning; scoped sanitized hardening is not a posture change.
