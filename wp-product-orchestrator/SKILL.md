...
- If exact project setup is missing and no new owner/product source-of-truth signal exists, return concise `DONT_NOTIFY/setup-blocked` status instead of full rehydration or retrying worker creation.
