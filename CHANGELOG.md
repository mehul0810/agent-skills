...
- **Project Subagent Routing Discipline**: Added shared guidance for project-level Codex subagents, skill-level routing, bounded mapper/reviewer/fixer roles, hooks boundaries, and availability-first model/reasoning allocation.
