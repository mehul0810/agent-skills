...
require_text "templates/product-repo/AGENTS.md" 'live-verified unprotected non-production branch' "safe non-production merge authority"
require_text "templates/product-repo/AGENTS.md" 'Never merge to a protected branch' "protected branch merge gate"
require_text "templates/product-repo/.codex/prompts/landpr.md" 'ambiguous protection status fails closed' "ambiguous protection gate"
require_text "templates/product-repo/AGENTS.md" 'Never merge to a protected branch or `main`/production' "production hard gate"
