...
| Merge/close | Merge PR or close issue/PR | Release/deploy/publish |
...
- No pricing, licensing, privacy, security disclosure, destructive data, or release decision is required.
...
Ask before doing or landing work that changes:
...
- Release branch policy, versioning, WordPress.org assets/SVN, marketplace submissions, or public release notes.
- Broad UI/brand direction, conversion strategy, SEO-critical templates, or content model.

## Reversible Default Rule

If a product choice is minor and reversible, choose the safer enterprise default and document it in the PR. If the choice affects customer expectations, paid functionality, data, security, privacy, SEO, or release behavior, stop and ask.
...
- A destructive command, migration, release, merge, or close would be needed.
